...
and binary rows. Currently, there are a total of four prewritten numeric summary
functions, as well as three prewritten functions for both categorical and binary data.
However, it is often the case that a user wants to have increased flexibility
and wants to format `tangram.pipe` output tables in a different way than provided by 
