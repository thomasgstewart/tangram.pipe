...
tbl1 <- tbl_start(data=iris, col_var="Species", missing=FALSE, overall=TRUE, comparison=FALSE) %>% 
  ...
  tbl_out() %>%
  print()
tbl1 %>% tangram_styling() %>% kable(escape=F, align="l") %>% trimws %>% kable_styling(c("striped","bordered"))
```
```{r, echo=FALSE}
tbl1 <- tbl_start(data=iris, col_var="Species", missing=FALSE, overall=TRUE, comparison=FALSE) %>% 
  num_row(row_var="Sepal.Length", rowlabels="Sepal Length") %>%
  tbl_out()
tbl1[[7]] %>% tangram_styling() %>% kable(escape=F, align="l") %>% trimws %>% kable_styling(c("striped","bordered"))
```
...
tbl1 <- tbl_start(iris, "Species", missing=FALSE, overall=TRUE, comparison=TRUE) %>%
  ...
  binary_row("color", comparison=binary_or, indent=3) %>%
  tbl_out()
tbl1[[13]] %>% tangram_styling() %>% kable(escape=F, align="l") %>% trimws %>% kable_styling(c("striped","bordered"))
```
...
tbl1 <- tbl_start(iris, NULL, missing=FALSE, overall=TRUE, comparison=FALSE) %>%
  num_row("Sepal.Length", rowlabels="Sepal Length") %>%
  tbl_out()
tbl1[[8]] %>% tangram_styling() %>% kable(escape=F, align="l") %>% trimws %>% kable_styling(c("striped","bordered"))
```
...
tbl1 <- tbl_start(sepaldat, "Species", missing=FALSE, overall=TRUE, comparison=FALSE) %>%
  ...
  tbl_out()
tbl1[[12]] %>% tangram_styling() %>% kable(escape=F, align="l") %>% trimws %>% kable_styling(c("striped","bordered"))
```
